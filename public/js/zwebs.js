...
(function() {
  ...
  hm.src = "https://hm.baidu.com/hm.js?25d110c1412dc6f78171d18893a72530";
...
(function() {
  ...
  ghm.src = "https://www.googletagmanager.com/gtag/js?id=G-HGQV947JQE";
  var gs = document.getElementsByTagName("script")[0];
  gs.parentNode.insertBefore(ghm, gs);
  window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'G-HGQV947JQE');
})();
